...
const MovieCard = ({ title, image, year, duration, rating, delay = 0, onPlay }: MovieCardProps) => {
  ...
  return (
    ...
    >
      <div className="relative aspect-[2/3] rounded-lg overflow-hidden">
        ...
        >
          <h3 className="font-bold text-foreground text-sm mb-1 line-clamp-2">{title}</h3>
